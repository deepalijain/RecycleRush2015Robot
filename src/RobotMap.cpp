...
void RobotMap::init() {
	...
	driveFrontLeft = Ct->Init(1, (char *)"FrontLeft");
	...
	driveSubsystem = new RobotDrive(driveFrontLeft, driveFrontRight);
	...
	driveSubsystem->SetSafetyEnabled(false);
        ...
        driveSubsystem->SetInvertedMotor(RobotDrive::kRearRightMotor, true);

	driveBackLeft = Ct->Init(2, (char *)"BackLeft");
	//driveBackLeft = new TalonSRX(2);
	lw->AddActuator("DriveSubsystem", "backLeftMotor", (TalonSRX*) driveBackLeft);

	driveBackRight = Ct->Init(4, (char *)"BackRight");
	...
	pickupMotor1 = 	driveBackRight = Ct->Init(7, (char *)"Pickup Lead");
	lw->AddActuator("PickupSubsystem", "pickupMotor1", (Talon*) pickupMotor1);
	
	pickupMotor2 = driveBackRight = Ct->Init(8, (char *)"Pickup Follow");
